module.exports = {
  ...
  USERINFO_ZETCOINS_TITLE: "GTA balance",
  USERINFO_ZETCOINS_BALANCE: amount => `${amount} GTA`,
  ...
  USERINFO_ZETCOINS_TOP: "GTA top position",
  ...
  BALANCE_COMMAND_DESCRIPTION: "shows your (or provided user's) GTA balance",
  BALANCE_COMMAND_USAGE: "[user]",
  BALANCE_EMBED_AUTHOR_NAME: user => `${user.username}#${user.discriminator}'s balance:`,
  BALANCE_EMBED_DESCRIPTION: amount => `<:zetcoins:766959525864669235> ${amount} GTA.`,
  ...
  SENDCOINS_COMMAND_DESCRIPTION: "sends an amount of GTA to user",
  SENDCOINS_COMMAND_USAGE: "<user> <amount>",
  SENDCOINS_NO_ARGS_PROMPT: prefix => `> :x: What user you want to send GTA to? Use \`${prefix}sendcoins <user> <amount>\``,
  SENDCOINS_NO_AMOUNT: "> :x: Please provide a valid amount of GTA that you want to send.",
  SENDCOINS_AMOUNT_IS_NAN: "> :x: Provided amount is not a number.",
  SENDCOINS_CONFIRMATION_TITLE: (amount, user) => `Are you really want to send ${amount} GTA to **${user.username}#${user.discriminator}**?`,
  SENDCOINS_CONFIRMATION_DESCRIPTION: "Type `yes`/`y` or `no`/`n`.\nYou have 30 seconds to agree.",
  SENDCOINS_SUCCESSFULLY_SENT: (amount, user) => `:white_check_mark: Successfully sent ${amount} GTA to **${user.username + "#" + user.discriminator}**.`,
  SENDCOINS_CANCELLED_TRANSACTION: `:x: Transaction is cancelled by user.`,
  SENDCOINS_NOT_ENOUGH_MONEY: amount => `> :x: You don't have enough money. Your balance: ${amount} GTA.`,
  SENDCOINS_TIME_EXPIRED: ":x: Time expired.",
  CANNOT_SEND_COINS_TO_SELF: "> :x: You can't send GTA to self.",
  CANNOT_SEND_COINS_TO_BOT: "> :x: You can't send GTA to bot.",
  CANNOT_SEND_COINS_TO_BANNED_BALANCE: "> :x: You can't send GTA to user with blocked balance.",
  ...
  SETBALANCE_NO_AMOUNT: "> :x: Please provide an amount of GTA you want to set.",
  ...
  SETBALANCE_EMBED_DESCRIPTION: amount => `Now this user has ${amount} GTA.`,
  ...
  TOP_BALANCE: balance => `<:zetcoins:766959525864669235> ${balance} GTA.`,
  TOP_FOOTER: (position, balance) => `Your position in top is ${position}, and balance is ${balance} GTA.`,
  ...
  WORK_COMMAND_DESCRIPTION: "earn from 100 to 400 GTA (1 time per hour)",
  WORK_COOLDOWN_TITLE: ":x: Not so fast!",
  WORK_COOLDOWN_DESC: time => `You can work again in **${time}** mins.`,
  WORK_EMBED_TITLE: "Work",
  WORK_EMBED_DESCRIPTION: (amount, balance) => `**You earned: ${amount}** GTA <:zetcoins:766959525864669235>\n**Your balance: ${balance}** GTA <:zetcoins:766959525864669235>`,
  ...
  DICE_COMMAND_DESCRIPTION: "win or lose the amount of GTA",
  DICE_COMMAND_USAGE: "<amount>",
  DICE_NO_ARGS_PROMPT: prefix => `> :x: How much GTA you want to bet? Use \`${prefix}dice <amount>\``,
  DICE_NOT_ENOUGH_MONEY: balance => `> :x: You don't have enough GTA. Your balance: ${balance} GTA.`,
  DICE_AMOUNT_IS_NAN: "> :x: Provided amount is not a number.",
  DICE_WIN: ":money_with_wings: Win!",
  DICE_WIN_MESSAGE: (amount, balance) => `You won: **${amount}** GTA\nYour balance: **${balance + amount}** GTA`,
  DICE_LOSS: ":money_with_wings: Loss",
  DICE_LOSS_MESSAGE: (amount, balance) => `You lost: **${amount}** GTA\nYour balance: **${balance - amount}** GTA`,
  ...
  DEPOSIT_DESCRIPTION: "lets you to put or withdraw GTA from deposit. Use this command without arguments to get more info",
  DEPOSIT_EMBED_TITLE: "Deposit help",
  DEPOSIT_EMBED_DESC: "You can put your GTA to the deposit.\nHowever, you won't be able to use them, and this sum won't be counted in the top.\nEvery 2 hours 1% of the sum on deposit will be charged. Limit is 250000 GTA.",
  ...
  DEPOSIT_NOT_ENOUGH_MONEY: bal => `> :x: You don't have enough GTA. Your balance: ${bal} GTA.`,
  DEPOSIT_PUT_SUCCESS: "Successfully put to deposit!",
  DEPOSIT_TOTAL: "Deposit",
  DEPOSIT_NOT_ENOUGH_DEPOSIT: bal => `> :x: You don't have enough GTA on deposit. Your deposit balance: ${bal} GTA.`,
