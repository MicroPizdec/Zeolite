module.exports = {
  ...
  USERINFO_ZETCOINS_TITLE: "Breads balance",
  USERINFO_ZETCOINS_BALANCE: amount => `${amount} breads`,
  ...
  USERINFO_ZETCOINS_TOP: "Breads top position",
  ...
  BALANCE_COMMAND_DESCRIPTION: "shows your (or provided user's) breads balance",
  BALANCE_COMMAND_USAGE: "[user]",
  BALANCE_EMBED_AUTHOR_NAME: user => `${user.username}#${user.discriminator}'s balance:`,
  BALANCE_EMBED_DESCRIPTION: amount => `:bread: ${amount} breads.`,
  ...
  SENDCOINS_COMMAND_DESCRIPTION: "sends an amount of breads to user",
  SENDCOINS_COMMAND_USAGE: "<user> <amount>",
  SENDCOINS_NO_ARGS_PROMPT: prefix => `> :x: What user you want to send breads to? Use \`${prefix}sendcoins <user> <amount>\``,
  SENDCOINS_NO_AMOUNT: "> :x: Please provide a valid amount of breads that you want to send.",
  SENDCOINS_AMOUNT_IS_NAN: "> :x: Provided amount is not a number.",
  SENDCOINS_CONFIRMATION_TITLE: (amount, user) => `Are you really want to send ${amount} breads to **${user.username}#${user.discriminator}**?`,
  SENDCOINS_CONFIRMATION_DESCRIPTION: "Type `yes`/`y` or `no`/`n`.\nYou have 30 seconds to agree.",
  SENDCOINS_SUCCESSFULLY_SENT: (amount, user) => `:white_check_mark: Successfully sent ${amount} breads to **${user.username + "#" + user.discriminator}**.`,
  SENDCOINS_CANCELLED_TRANSACTION: `:x: Transaction is cancelled by user.`,
  SENDCOINS_NOT_ENOUGH_MONEY: amount => `> :x: You don't have enough money. Your balance: ${amount} breads.`,
  SENDCOINS_TIME_EXPIRED: ":x: Time expired.",
  CANNOT_SEND_COINS_TO_SELF: "> :x: You can't send breads to self.",
  CANNOT_SEND_COINS_TO_BOT: "> :x: You can't send breads to bot.",
  CANNOT_SEND_COINS_TO_BANNED_BALANCE: "> :x: You can't send breads to user with blocked balance.",
  ...
  SETBALANCE_NO_AMOUNT: "> :x: Please provide an amount of breads you want to set.",
  ...
  SETBALANCE_EMBED_DESCRIPTION: amount => `Now this user has ${amount} breads.`,
  ...
  TOP_BALANCE: balance => `:bread: ${balance} breads.`,
  TOP_FOOTER: (position, balance) => `Your position in top is ${position}, and balance is ${balance} breads.`,
  ...
  WORK_COMMAND_DESCRIPTION: "earn from 100 to 400 breads (1 time per hour)",
  WORK_COOLDOWN_TITLE: ":x: Not so fast!",
  WORK_COOLDOWN_DESC: time => `You can work again in **${time}** mins.`,
  WORK_EMBED_TITLE: "Work",
  WORK_EMBED_DESCRIPTION: (amount, balance) => `**You earned: ${amount}** breads :bread:\n**Your balance: ${balance}** breads :bread:`,
  ...
  DICE_COMMAND_DESCRIPTION: "win or lose the amount of breads",
  DICE_COMMAND_USAGE: "<amount>",
  DICE_NO_ARGS_PROMPT: prefix => `> :x: How much breads you want to bet? Use \`${prefix}dice <amount>\``,
  DICE_NOT_ENOUGH_MONEY: balance => `> :x: You don't have enough breads. Your balance: ${balance} breads.`,
  DICE_AMOUNT_IS_NAN: "> :x: Provided amount is not a number.",
  DICE_WIN: ":money_with_wings: Win!",
  DICE_WIN_MESSAGE: (amount, balance) => `You won: **${amount}** breads\nYour balance: **${balance + amount}** breads`,
  DICE_LOSS: ":money_with_wings: Loss",
  DICE_LOSS_MESSAGE: (amount, balance) => `You lost: **${amount}** breads\nYour balance: **${balance - amount}** breads`,
  ...
  DEPOSIT_DESCRIPTION: "lets you to put or withdraw breads from deposit. Use this command without arguments to get more info",
  DEPOSIT_EMBED_TITLE: "Deposit help",
  DEPOSIT_EMBED_DESC: "You can put your breads to the deposit.\nHowever, you won't be able to use them, and this sum won't be counted in the top.\nEvery 2 hours 1% of the sum on deposit will be charged. Limit is 250000 breads.",
  ...
  DEPOSIT_NOT_ENOUGH_MONEY: bal => `> :x: You don't have enough breads. Your balance: ${bal} breads.`,
  DEPOSIT_PUT_SUCCESS: "Successfully put to deposit!",
  DEPOSIT_TOTAL: "Deposit",
  DEPOSIT_NOT_ENOUGH_DEPOSIT: bal => `> :x: You don't have enough breads on deposit. Your deposit balance: ${bal} breads.`,
