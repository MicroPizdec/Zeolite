module.exports = {
  ...
  USERINFO_ZETCOINS_TITLE: "Кол-во хлебов",
  USERINFO_ZETCOINS_BALANCE: amount => `${amount} хлебов`,
  ...
  BALANCE_COMMAND_DESCRIPTION: "показывает ваше (или другого пользователя) кол-во хлебов на счету",
  BALANCE_COMMAND_USAGE: "[пользователь]",
  BALANCE_EMBED_AUTHOR_NAME: user => `Баланс ${user.username}#${user.discriminator}`,
  BALANCE_EMBED_DESCRIPTION: amount => `:bread: ${amount} хлебов.`,
  ...
  SENDCOINS_COMMAND_DESCRIPTION: "передать указанное кол-во хлебов пользователю",
  SENDCOINS_COMMAND_USAGE: "<пользователь> <кол-во>",
  SENDCOINS_NO_ARGS_PROMPT: prefix => `> :x: Кому вы хотите передать хлебы? Используйте \`${prefix}sendcoins <пользователь> <кол-во>\``,
  SENDCOINS_NO_AMOUNT: "> :x: Укажите кол-во хлебов, которое вы хотите передать.",
  SENDCOINS_AMOUNT_IS_NAN: "> :x: Указанное кол-во не является числом.",
  SENDCOINS_CONFIRMATION_TITLE: (amount, user) => `Вы точно хотите передать ${amount} хлебов пользователю **${user.username}#${user.discriminator}**?`,
  SENDCOINS_CONFIRMATION_DESCRIPTION: "Напишите `yes`/`y` или `no`/`n`.\nУ вас 30 секунд для подтверждения.",
  SENDCOINS_SUCCESSFULLY_SENT: (amount, user) => `:white_check_mark: Успешно передано ${amount} хлебов пользователю **${user.username + "#" + user.discriminator}**.`,
  SENDCOINS_CANCELLED_TRANSACTION: `:x: Перевод отменен пользователем.`,
  SENDCOINS_NOT_ENOUGH_MONEY: amount => `> :x: Недостаточно средств на счету. Ваш баланс: ${amount} хлебов.`,
  SENDCOINS_TIME_EXPIRED: ":x: Время вышло.",
  CANNOT_SEND_COINS_TO_SELF: "> :x: Вы не можете передать хлебы самому себе.",
  CANNOT_SEND_COINS_TO_BOT: "> :x: Вы не можете передать хлебы боту.",
  CANNOT_SEND_COINS_TO_BANNED_BALANCE: "> :x: Вы не можете переводить хлебы пользователю с заблокированным балансом.",

  SETBALANCE_COMMAND_DESCRIPTION: "задает кол-во хлебов пользователю",
  ...
  SETBALANCE_NO_AMOUNT: "> :x: Укажите кол-во хлебов, которое вы хотите задать.",
  ...
  SETBALANCE_EMBED_DESCRIPTION: amount => `Теперь данный пользователь имеет ${amount} хлебов`,
  ...
  TOP_FOOTER: (position, balance) => `Ваша позиция в топе - ${position}, баланс - ${balance} хлебов.`,
  TOP_BALANCE: balance => `:bread: ${balance} хлебов.`,
  ...
  WORK_COMMAND_DESCRIPTION: "получить от 100 до 400 хлебов (раз в час)",
  WORK_COOLDOWN_TITLE: ":x: Не так быстро!",
  WORK_COOLDOWN_DESC: time => `Работа будет доступна через **${time}** минут.`,
  WORK_EMBED_TITLE: "Работа",
  WORK_EMBED_DESCRIPTION: (amount, balance) => `**Вы заработали: ${amount}** хлебов :bread:\n**Ваш баланс: ${balance}** хлебов :bread:`,
  ...
  DICE_COMMAND_DESCRIPTION: "выиграть или потерять кол-во хлебов",
  DICE_COMMAND_USAGE: "<кол-во>",
  DICE_NO_ARGS_PROMPT: prefix => `> :x: Сколько хлебов вы хотите поставить? Используйте \`${prefix}dice <кол-во>\``,
  DICE_NOT_ENOUGH_MONEY: balance => `> :x: Недостаточно хлебов на счету. Ваш баланс: ${balance} хлебов.`,
  DICE_AMOUNT_IS_NAN: "> :x: Указанное кол-во не является числом.",
  DICE_WIN: ":money_with_wings: Выигрыш!",
  DICE_WIN_MESSAGE: (amount, balance) => `Вы выиграли: **${amount}** хлебов\nВаш баланс: **${balance + amount}** хлебов`,
  DICE_LOSS: ":money_with_wings: Проигрыш",
  DICE_LOSS_MESSAGE: (amount, balance) => `Вы проиграли: **${amount}** хлебов\nВаш баланс: **${balance - amount}** хлебов`,
  ...
  LIMITCMD_DESCRIPTION: "Ограничивает указанную команду.\nКлюч -h или --hide также скрывает команду со справки",
  ...
  DEPOSIT_DESCRIPTION: "позволяет вам внести или снять хлебы с депозита. Используйте эту команду без аргументов для получения подробной информации",
  DEPOSIT_EMBED_TITLE: "Справка по депозитам",
  DEPOSIT_EMBED_DESC: "Вы можете внести хлебы на депозит.\nПри этом, вы не сможете использовать их и эта сумма не будет учитываться в топе до того, как вы их снимете.\nКаждые 2 часа будет начисляться 1% от суммы на депозите. Лимит 250000 хлебов.",
  DEPOSIT_USAGE: "Как использовать",
  DEPOSIT_USAGE_DESC: prefix => `\`${prefix}deposit put <сумма>\n${prefix}deposit wd <сумма>\``,
  DEPOSIT_NOT_ENOUGH_MONEY: bal => `> :x: Недостаточно средств. Ваш баланс: ${bal} хлебов.`,
  DEPOSIT_PUT_SUCCESS: "Успешно внесено в депозит!",
  DEPOSIT_TOTAL: "Депозит",
  DEPOSIT_NOT_ENOUGH_DEPOSIT: bal => `> :x: Недостаточно средств на депозите. Ваш депозит: ${bal} хлебов.`,
  DEPOSIT_WD_SUCCESS: "Успешно снято с депозита!",
  DEPOSIT_YOUR_BALANCE: "Ваш баланс",
  DEPOSIT_INVALID_SUM: "> :x: Указана неверная сумма.",
  ...
  TAGS_SAME_NAME: "> :x: Новое имя не должно быть таким же, как существующее имя.",
  ...
  NOT_NSFW_CHANNEL: cmd => `> :x: Команда \`${cmd}\` может быть использована только на каналах, помеченных как NSFW.`,
  ...
  RULE34_URL: "Ссылка на публикацию",
  ...
  HENTAI_ERROR: err => `> :x: Произошла ошибка. \`${err}\``, 

  HENTAIASS_DESCRIPTION: "Получает случайное хентай-изображение задницы.\nЭту команду можно использовать только в каналах помеченных как NSFW",
