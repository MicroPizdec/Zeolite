module.exports = {
  ...
  USERINFO_ZETCOINS_TITLE: "Кол-во ГТА",
  USERINFO_ZETCOINS_BALANCE: amount => `${amount} ГТА`,
  ...
  BALANCE_COMMAND_DESCRIPTION: "показывает ваше (или другого пользователя) кол-во ГТА на счету",
  BALANCE_COMMAND_USAGE: "[пользователь]",
  BALANCE_EMBED_AUTHOR_NAME: user => `Баланс ${user.username}#${user.discriminator}`,
  BALANCE_EMBED_DESCRIPTION: amount => `<:zetcoins:766959525864669235> ${amount} ГТА.`,
  ...
  SENDCOINS_COMMAND_DESCRIPTION: "передать указанное кол-во ГТА пользователю",
  SENDCOINS_COMMAND_USAGE: "<пользователь> <кол-во>",
  SENDCOINS_NO_ARGS_PROMPT: prefix => `> :x: Кому вы хотите передать ГТА? Используйте \`${prefix}sendcoins <пользователь> <кол-во>\``,
  SENDCOINS_NO_AMOUNT: "> :x: Укажите кол-во ГТА, которое вы хотите передать.",
  SENDCOINS_AMOUNT_IS_NAN: "> :x: Указанное кол-во не является числом.",
  SENDCOINS_CONFIRMATION_TITLE: (amount, user) => `Вы точно хотите передать ${amount} ГТА пользователю **${user.username}#${user.discriminator}**?`,
  SENDCOINS_CONFIRMATION_DESCRIPTION: "Напишите `yes`/`y` или `no`/`n`.\nУ вас 30 секунд для подтверждения.",
  SENDCOINS_SUCCESSFULLY_SENT: (amount, user) => `:white_check_mark: Успешно передано ${amount} ГТА пользователю **${user.username + "#" + user.discriminator}**.`,
  SENDCOINS_CANCELLED_TRANSACTION: `:x: Перевод отменен пользователем.`,
  SENDCOINS_NOT_ENOUGH_MONEY: amount => `> :x: Недостаточно средств на счету. Ваш баланс: ${amount} ГТА.`,
  SENDCOINS_TIME_EXPIRED: ":x: Время вышло.",
  CANNOT_SEND_COINS_TO_SELF: "> :x: Вы не можете передать ГТА самому себе.",
  CANNOT_SEND_COINS_TO_BOT: "> :x: Вы не можете передать ГТА боту.",
  CANNOT_SEND_COINS_TO_BANNED_BALANCE: "> :x: Вы не можете переводить ГТА пользователю с заблокированным балансом.",

  SETBALANCE_COMMAND_DESCRIPTION: "задает кол-во ГТА пользователю",
  ...
  SETBALANCE_NO_AMOUNT: "> :x: Укажите кол-во ГТА, которое вы хотите задать.",
  ...
  SETBALANCE_EMBED_DESCRIPTION: amount => `Теперь данный пользователь имеет ${amount} ГТА`,
  ...
  TOP_FOOTER: (position, balance) => `Ваша позиция в топе - ${position}, баланс - ${balance} ГТА.`,
  TOP_BALANCE: balance => `<:zetcoins:766959525864669235> ${balance} ГТА.`,
  ...
  WORK_COMMAND_DESCRIPTION: "получить от 100 до 400 ГТА (раз в час)",
  WORK_COOLDOWN_TITLE: ":x: Не так быстро!",
  WORK_COOLDOWN_DESC: time => `Работа будет доступна через **${time}** минут.`,
  WORK_EMBED_TITLE: "Работа",
  WORK_EMBED_DESCRIPTION: (amount, balance) => `**Вы заработали: ${amount}** ГТА <:zetcoins:766959525864669235>\n**Ваш баланс: ${balance}** ГТА <:zetcoins:766959525864669235>`,
  ...
  DICE_COMMAND_DESCRIPTION: "выиграть или потерять кол-во ГТА",
  DICE_COMMAND_USAGE: "<кол-во>",
  DICE_NO_ARGS_PROMPT: prefix => `> :x: Сколько ГТА вы хотите поставить? Используйте \`${prefix}dice <кол-во>\``,
  DICE_NOT_ENOUGH_MONEY: balance => `> :x: Недостаточно ГТА на счету. Ваш баланс: ${balance} ГТА.`,
  DICE_AMOUNT_IS_NAN: "> :x: Указанное кол-во не является числом.",
  DICE_WIN: ":money_with_wings: Выигрыш!",
  DICE_WIN_MESSAGE: (amount, balance) => `Вы выиграли: **${amount}** ГТА\nВаш баланс: **${balance + amount}** ГТА`,
  DICE_LOSS: ":money_with_wings: Проигрыш",
  DICE_LOSS_MESSAGE: (amount, balance) => `Вы проиграли: **${amount}** ГТА\nВаш баланс: **${balance - amount}** ГТА`,
  ...
  DEPOSIT_DESCRIPTION: "позволяет вам внести или снять ГТА с депозита. Используйте эту команду без аргументов для получения подробной информации",
  DEPOSIT_EMBED_TITLE: "Справка по депозитам",
  DEPOSIT_EMBED_DESC: "Вы можете внести ГТА на депозит.\nПри этом, вы не сможете использовать их и эта сумма не будет учитываться в топе до того, как вы их снимете.\nКаждые 2 часа будет начисляться 1% от суммы на депозите. Лимит 250000 ГТА.",
  DEPOSIT_USAGE: "Как использовать",
  DEPOSIT_USAGE_DESC: prefix => `\`${prefix}deposit put <сумма>\n${prefix}deposit wd <сумма>\``,
  DEPOSIT_NOT_ENOUGH_MONEY: bal => `> :x: Недостаточно средств. Ваш баланс: ${bal} ГТА.`,
  DEPOSIT_PUT_SUCCESS: "Успешно внесено в депозит!",
  DEPOSIT_TOTAL: "Депозит",
  DEPOSIT_NOT_ENOUGH_DEPOSIT: bal => `> :x: Недостаточно средств на депозите. Ваш депозит: ${bal} ГТА.`,
