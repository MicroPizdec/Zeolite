const answers = {
    ru: [
      ...
      '**?/10**\nКаво?',
      '**?/10**\nКаво и шо?',
      '**?/10**\nДа пошло оно всё нахуй, опять всё это читать!!',
      '**?/10**\nЭто чё, ёпта?',
      '**?/10**\nЬЫААЫООУЭ ЫАОЫАОЭЕОЫ',
      '**NaN/10**\nNaN',
      '**undefined/10**\nundefined',
      ...
      '**0/10**\nПоебать в квадрате!',
      '**0/10**\nНу ка нахуй отсюда, чтобы ни одного падлу блядь не видел здесь никогда!',
      '**0/10**\nО-ох, хуета, пошёл нахуй.',
      '**0/10**\nГений, блядь.',
      '**1/10**\n:star: you tried',
      '**1/10**\nСмешно. Смеёмся.',
      '**1/10**\nПрикол не оценили, в изолятор, долбоёб.',
      '**1/10**\nДолбоёб, не по сценарию!',
      ...
      '**1/10**\nОрудие к расстрелу за плохую шутку!',
      '**1/10**\nТы ебанько что-ли?',
      '**1/10**\n:candle: *пиздец...*',
      '**1/10**\n:candle: *Похуй...*',
      ...
      '**2/10**\nНихуя, садись 2.',
      '**2/10**\n:knife: иди сюда.',
      '**2/10**\n:knife: ты доигрался чукча ебаная.',
      ...
      '**2/10**\nИди, иди. Ты бля оглох? Давай уёбывай, сука, беги!',
      '**2/10**\nЯ по ржал, но не сильно.',
      '**2/10**\nНе занимайся юмором, иначе я тебе ебальник снесу.',
      '**2/10**\nПоебать!',
      '**2/10**\nВсем интересно!',
      '**2/10**\nЧел, шутка - это когда смешно, а не когда хочется ебальник набить!',
      '**3/10**\n:family: Бля.',
      '**3/10**\nКрутой!! Пашол нахуй!!',
      '**3/10**\nМиссия проёбана.',
      '**3/10**\nВау.',
      ...
      '**100/10**\nХорошая работа, ты просто молодец, красава, талантище!',
    ],
    en: [
      '**?/10**\nwhat.',
      '**?/10**\nI don\'t understand.',
      ...
      '**8/10**\nNice.',
      '**10/10**\nAwesome.',
      '**10/10**\nThat\'s a REALLY good joke. Good job!',
    ],
  };
