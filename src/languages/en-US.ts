export default {
  ...
  infoTitle: 'About bot',
  infoDesc:
    '**Let your journey begin.**\nA multipurpose bot that simple in terms of economy, moderation, and more, written on TypeScript with Oceanic.js library.',
  infoLinks: 'Links',
  ...
  payConfirmationTitle: 'Do you really want to send %d %s to **%s**?',
  ...
  commands: 'Commands',
  helpDesc:
    'To get more information about some command use [our wiki](https://github.com/MicroPizdec/Zeolite/wiki/Commands-list-(EN)).\nAny questions about bot? Join [our support server](https://discord.gg/ZKChwBD).',
  ...
  tagNameTooLong: "> :x: Tag name shouldn't be longer than 128 characters.",
  tagAlreadyExist: '> :x: This tag is already exist.',
  tagAddSuccess: '> :white_check_mark: Tag `%s` successfully added!',
  tagNotExist: '> :x: This tag does not exist.',
  tagsNotOwner: ":x: This tag doesn't exist or you don't own it.",
  tagEditSuccess: '> :white_check_mark: Tag `%s` successfully edited!',
  tagNewNameTooLong: "> :x: Tag new name shouldn't be longer than 128 characters.",
  tagsSameName: "> :x: New name shouldn't be the same as the existing name.",
  tagRenameSuccess: '> :white_check_mark: Tag `%s` successfully renamed to `%s`!',
  alreadyOwnTag: '> :x: You already own `%s` tag!',
  tagTransferSuccess: '> :white_check_mark: Tag `%s` successfully transfered to %s',
