module.exports = {
  ...
  DICE_TITLE: "Casino",
  DICE_WIN_MESSAGE: (amount, balance) => `**Win!**\nYou won: **${amount}** ZetCoins\nYour balance: **${balance + amount}** ZetCoins`,
  DICE_LOSS_MESSAGE: (amount, balance) => `**\*sad trombone\*** \nYou lost: **${amount}** ZetCoins\nYour balance: **${balance - amount}** ZetCoins`,
  ...
  INFO_EMBED_DESC: "hmmm what to write here...",
  INFO_DEVS: "Developer",
  INFO_LINKS: "Links",
  ...
  EMBEDCOLOR_USAGE: "[color: #hex or number]",
  EMBEDCOLOR_YOUR_COLOR: "Your embed color",
  EMBEDCOLOR_DEFAULT: "default",
  EMBEDCOLOR_FOOTER: prefix => `Use ${prefix}embedcolor [color: #hex or number] if you want to change the embed color`,
